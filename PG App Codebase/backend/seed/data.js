...
export const PGS = [
  ...
  {
    name: 'Silicon Stay',
    slug: 'silicon-stay-hsr-layout-bangalore',
    description: 'Modern PG in HSR Layout for tech professionals. Fully furnished rooms, fast WiFi, and excellent food. Walking distance from major startups.',
    location: {
      country: 'India',
      state: 'Karnataka',
      city: 'Bangalore',
      area: 'HSR Layout',
      address: '14, 27th Main Road, HSR Layout, Bangalore - 560102',
