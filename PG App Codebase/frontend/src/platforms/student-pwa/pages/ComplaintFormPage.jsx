  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (err.response?.status === 429) {
        setError('You already submitted a complaint for this PG recently. Please wait 15 minutes before trying again.')
        return
      }
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-[10px] border border-[#e0e0e0]">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Your name won&apos;t be shown publicly. The admin will still see your account for moderation.
                  </p>
                </div>
              </div>
