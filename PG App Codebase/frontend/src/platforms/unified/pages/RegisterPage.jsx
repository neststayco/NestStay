          ...
          <div className="bg-white rounded-2xl border border-[#E5E7EB] p-8 shadow-card">
            <div className="mb-6">
              ...
              <p className="text-sm text-[#434849] mt-1">
                {step === 1 ? 'Join Nest Stay to find your perfect PG' : `We sent a 6-digit code to ${email}`}
              </p>
            </div>
            ...
            {step === 1 ? (
              ...
              <form onSubmit={handleVerify} className="space-y-5" noValidate>
                {/* OTP */}
                <div>
                  <label className="block text-sm font-semibold text-[#1b1c1c] mb-2" htmlFor="reg-otp">
                    Verification code
                  </label>
                  <input
                    id="reg-otp"
                    ...
                    aria-describedby={fieldErrors.otp ? 'reg-otp-err' : undefined}
                  />
                  {fieldErrors.otp && (
                    <p id="reg-otp-err" className="mt-1.5 text-xs text-red-600">{fieldErrors.otp}</p>
                  )}
